...
API_FILES = [join('multiarray', 'array_assign_array.cpp'),
             join('multiarray', 'array_assign_scalar.cpp'),
             join('multiarray', 'arrayobject.cpp'),
             join('multiarray', 'arraytypes.cpp.src'),
             join('multiarray', 'buffer.cpp'),
             join('multiarray', 'calculation.cpp'),
             join('multiarray', 'conversion_utils.cpp'),
             join('multiarray', 'convert.cpp'),
             join('multiarray', 'convert_datatype.cpp'),
             join('multiarray', 'ctors.cpp'),
             join('multiarray', 'datetime.cpp'),
             join('multiarray', 'datetime_busday.cpp'),
             join('multiarray', 'datetime_busdaycal.cpp'),
             join('multiarray', 'datetime_strings.cpp'),
             join('multiarray', 'descriptor.cpp'),
             join('multiarray', 'einsum.cpp.src'),
             join('multiarray', 'flagsobject.cpp'),
             join('multiarray', 'getset.cpp'),
             join('multiarray', 'item_selection.cpp'),
             join('multiarray', 'iterators.cpp'),
             join('multiarray', 'methods.cpp'),
             join('multiarray', 'multiarraymodule.cpp'),
             join('multiarray', 'na_mask.cpp'),
             join('multiarray', 'na_object.cpp'),
             join('multiarray', 'nditer_api.cpp'),
             join('multiarray', 'nditer_constr.cpp'),
             join('multiarray', 'nditer_pywrap.cpp'),
             join('multiarray', 'nditer_templ.cpp.src'),
             join('multiarray', 'number.cpp'),
             join('multiarray', 'reduction.cpp'),
             join('multiarray', 'refcount.cpp'),
             join('multiarray', 'scalartypes.cpp.src'),
             join('multiarray', 'scalarapi.cpp'),
